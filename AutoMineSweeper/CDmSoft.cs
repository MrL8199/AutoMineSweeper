...
namespace CShapDM
{
    ...
    class CDmSoft : IDisposable
    {
        ...
        public int FindStr(int x1,int  y1,int  x2,int  y2,string  str,string color,double  sim, int v, out object x, out object y)
        {
        ...
        public int GetScreenData1(int x1,int  y1,int  x2,int  y2)
        {
        ...
        public int FindPic1(int x1,int  y1,int  x2,int  y2,string  pic_name,string  delta_color,double  sim,int  dir, out object x, out object y)
        {
        ...
        public string FindStrFastE1(int x1,int  y1,int  x2,int  y2,string str,string  color,double  sim)
        {
        ...
        public void Dispose()
        {
            //Must be true
            Dispose(true);
            //Notify the garbage collector that the finalizer (destructor) is no longer called
